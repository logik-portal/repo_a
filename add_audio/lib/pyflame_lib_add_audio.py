...
class PyFlameLabel(QtWidgets.QLabel):
    ...
    Parameters:
        ...
        width (int): Label width.
            Default: 150
        max_width (int, optional): Maximum label width. Ignored unless value is provided.
            Default: 0
        max_height (int, optional): Maximum label height. Ignored unless value is provided.
            Default: 0
...
class PyFlameLineEdit(QtWidgets.QLineEdit):
    ...
    Parameters:
        ...
        height (int): Height of lineedit widget.
            Default: 28
        max_width (int, optional): Maximum width of widget. Ignored unless value is provided.
            Default: 0
...
class PyFlameListWidget(QtWidgets.QListWidget):
    ...
    Parameters:
        ...
        height (int): Widget height.
            Default: 250
        max_width (int, optional): Widget maximum width. Ignored unless value is provided.
            Default: 0
        max_height (int, optional): Widget maximum height. Ignored unless value is provided.
            Default: 0
...
class PyFlamePushButton(QtWidgets.QPushButton):
    ...
    Parameters:
        ...
        width (int): Button width.
            Default: 150
        max_width (int, optional): Maximum button width. Ignored unless value is provided.
            Default: 0
        tooltip (str, optional): Button tooltip text.
            Default: None
        font (str): Button font.
...
class PyFlamePushButtonMenu(QtWidgets.QPushButton):
    ...
    Parameters:
        ...
        height (int): Button height.
            Default: 28
        max_width (int, optional): Button maximum width. Ignored unless value is provided.
            Default: 0
...
class PyFlameTextEdit(QtWidgets.QTextEdit):
    ...
    Parameters:
        ...
        height (int): Height of text edit.
            Default: 100
        max_width (int, optional): Maximum width of text edit. Ignored unless value is provided.
            Default: 0
        max_height (int, optional): Maximum height of text edit. Ignored unless value is provided.
            Default: 0
...
class PyFlameTokenPushButton(QtWidgets.QPushButton):
    ...
    Parameters:
        ...
        height (int): Button height.
            Default: 28
        max_width (int, optional): Button max width. Ignored unless value is provided.
            Default: 0
        font (str): Button font.
            Default: PYFLAME_FONT
        font_size (int): Button font size.
...
class PyFlameTreeWidget(QtWidgets.QTreeWidget):
    ...
    Parameters:
        ...
        height (int): Height of tree widget.
            Default: 100
        max_width (int, optional): Maximum width of tree widget. Ignored unless value is provided.
            Default: 0
        max_height (int, optional): Maximum height of tree widget. Ignored unless value is provided.
            Default: 0
